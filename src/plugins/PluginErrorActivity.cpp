...
PluginErrorActivity::PluginErrorActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, const char* message)
...
void PluginErrorActivity::render(RenderLock&&) {
  ...
  UITheme::drawCenteredWrappedText(
      renderer, Rect{metrics.contentSidePadding, bodyTop, pageWidth - 2 * metrics.contentSidePadding, bodyHeight},
